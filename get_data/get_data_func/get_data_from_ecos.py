...
def get_data_ecos_stat_search(code=list, period="D", start_date="20200101", end_date="20251101"):
  """
...
def process_data_stat_search(data):
    """
...
def get_data_from_ecos(codes, method="value", start_date="20230101", end_date="20260101"):
  ...
  for code in codes:
    ...
    data = get_data_ecos_stat_search(code=code_data, period=per, start_date=start_var, end_date=end_var)

    print("="*100)
    print("data :", data)
    processed_data, detail = process_data_stat_search(data)
